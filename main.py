...
writef('out/map/area.txt', "sea_area = {" + sea_provinces + "}") #海プロビ用地域
...
writef('out/map/region.txt', "japan_region = {sea_area}") #海プロビンス用リージョン
writef('out/map/superregion.txt', "india_superregion = {france_region}") #一時的に全リージョンをインドに
