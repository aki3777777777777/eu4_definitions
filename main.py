...
writef('out/map/area', "black_sea_area = {" + all_provinces + "}") #一時的に全プロビを黒海地域に入れる
writef('out/map/climate', "tropical = {" + all_provinces + "}") #一時的に全プロビを熱帯に
writef('out/map/continent', "europe = {" + all_provinces + "}") #一時的に全プロビをヨーロッパに
writef('out/map/region', "france_region = {black_sea_area}") #一時的に地域をフランスに
writef('out/map/superregion', "india_superregion = {france_region}") #一時的にｚ全リージョンをインドに
